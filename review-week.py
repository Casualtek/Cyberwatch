...
def ask_claude(news_count, most_hit_country, countries):
    ...
    message = client.messages.create(
        ...
        max_tokens=300,
        system='Tu es un journaliste spécialisé en cybersécurité. Tu prépares une revue de presse portant sur les cyberattaques rapportées dans la presse au cours de la semaine écoulée. Cette revue de presse s\'appelle le Cyberhebdo.',
        messages=[
